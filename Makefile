...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2021/11/15 16:08:34 by jlebre            #+#    #+#              #
#    Updated: 2021/11/15 16:51:25 by jlebre           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS	= ft_isascii.c ft_isprint.c ft_isalpha.c ft_isdigit.c ft_isalnum.c \
			...
			ft_memchr.c ft_memcmp.c ft_calloc.c ft_strtrim.c\
			ft_substr.c ft_strjoin.c ft_strdup.c
OBJS	= $(SRCS:.c=.o)
